              ...
              {user ? (
                <div className="flex items-center gap-4 py-4">
                  {user.photoURL ? (
                    ...
                    <div
                      className="w-14 h-14 rounded-full flex items-center justify-center font-hind font-bold text-xl"
                      style={{
                ...
                <button
                  onClick={signIn}
                  className="w-full flex items-center justify-center gap-3 py-3 px-6 rounded-xl font-hind font-semibold text-sm"
                  style={{
