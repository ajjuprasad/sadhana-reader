...
export default function HomeScreen() {
  ...
  return (
    ...
    <div className="px-4 pb-8 sm:pb-12">
      ...
      {/* Sentinel — when this scrolls out of view, the search bar is stuck */}
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          {/* Deity filter chips — always visible when not stuck, toggle when stuck */}
          {(!isStuck || chipsExpanded) && (
            <motion.div
              className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide mt-2.5"
              initial={isStuck ? { opacity: 0, height: 0 } : false}
