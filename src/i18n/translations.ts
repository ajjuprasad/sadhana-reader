...
const en: TranslationDict = {
  ...
  'home.shareMessage': 'Sādhanā Reader. Stotras, stories for kids, and a daily practice companion. Free and open source. {url}',
  'home.searchPlaceholder': 'Search stotras...',
  'home.allDeities': 'All',
  'home.noResults': 'No stotras found',
  'home.noResultsHint': 'Try a different search or filter',
...
const hi: TranslationDict = {
  ...
  'home.shareMessage': 'साधना रीडर। स्तोत्र, बच्चों के लिए कहानियाँ, और दैनिक साधना साथी। निःशुल्क और ओपन सोर्स। {url}',
  'home.searchPlaceholder': 'स्तोत्र खोजें...',
  'home.allDeities': 'सभी',
  'home.noResults': 'कोई स्तोत्र नहीं मिला',
  'home.noResultsHint': 'कोई अलग खोज या फ़िल्टर आज़माएं',
...
const kn: TranslationDict = {
  ...
  'home.shareMessage': 'ಸಾಧನಾ ರೀಡರ್. ಸ್ತೋತ್ರಗಳು, ಮಕ್ಕಳಿಗಾಗಿ ಕಥೆಗಳು, ಮತ್ತು ದೈನಂದಿನ ಸಾಧನಾ ಸಂಗಾತಿ. ಉಚಿತ ಮತ್ತು ಓಪನ್ ಸೋರ್ಸ್. {url}',
  'home.searchPlaceholder': 'ಸ್ತೋತ್ರಗಳನ್ನು ಹುಡುಕಿ...',
  'home.allDeities': 'ಎಲ್ಲಾ',
  'home.noResults': 'ಯಾವುದೇ ಸ್ತೋತ್ರಗಳು ಕಂಡುಬಂದಿಲ್ಲ',
  'home.noResultsHint': 'ಬೇರೆ ಹುಡುಕಾಟ ಅಥವಾ ಫಿಲ್ಟರ್ ಪ್ರಯತ್ನಿಸಿ',
...
const te: TranslationDict = {
  ...
  'home.shareMessage': 'సాధనా రీడర్. స్తోత్రాలు, పిల్లల కథలు, మరియు రోజువారీ సాధన సహచరుడు. ఉచితం మరియు ఓపెన్ సోర్స్. {url}',
  'home.searchPlaceholder': 'స్తోత్రాలు శోధించండి...',
  'home.allDeities': 'అన్నీ',
  'home.noResults': 'స్తోత్రాలు కనుగొనబడలేదు',
  'home.noResultsHint': 'వేరే శోధన లేదా ఫిల్టర్ ప్రయత్నించండి',
...
const ta: TranslationDict = {
  ...
  'home.shareMessage': 'சாதனா ரீடர். ஸ்தோத்திரங்கள், குழந்தைகளுக்கான கதைகள், மற்றும் தினசரி சாதனா துணை. இலவசம் மற்றும் ஓப்பன் சோர்ஸ். {url}',
  'home.searchPlaceholder': 'ஸ்தோத்திரங்களைத் தேடுங்கள்...',
  'home.allDeities': 'அனைத்தும்',
  'home.noResults': 'ஸ்தோத்திரங்கள் கிடைக்கவில்லை',
  'home.noResultsHint': 'வேறு தேடல் அல்லது வடிகட்டியை முயற்சிக்கவும்',
...
const ml: TranslationDict = {
  ...
  'home.shareMessage': 'സാധനാ റീഡർ. സ്തോത്രങ്ങൾ, കുട്ടികൾക്കുള്ള കഥകൾ, ദൈനംദിന സാധനാ സഹായി. സൗജന്യവും ഓപ്പൺ സോഴ്സും. {url}',
  'home.searchPlaceholder': 'സ്തോത്രങ്ങൾ തിരയുക...',
  'home.allDeities': 'എല്ലാം',
  'home.noResults': 'സ്തോത്രങ്ങൾ കണ്ടെത്തിയില്ല',
  'home.noResultsHint': 'മറ്റൊരു തിരയലോ ഫിൽട്ടറോ പരീക്ഷിക്കുക',
